...
int main(int argc,char**argv)
{
	...
	shapes::Mesh *bottle_mesh=shapes::createMeshFromResource("package://baxter_test/meshes/beer_bottle_up.stl",scale);
	...
	beer_bottle.object.mesh_poses[0].position.x = 0.912;
   	beer_bottle.object.mesh_poses[0].position.y = -0.257;
    	beer_bottle.object.mesh_poses[0].position.z = 0.05;
	...
	shapes::Mesh* pint_mesh=shapes::createMeshFromResource("package://baxter_test/meshes/beer_pint.stl",scale);
	...
	beer_pint.object.mesh_poses[0].position.x=1.094196;
	beer_pint.object.mesh_poses[0].position.y=0.160750;
	beer_pint.object.mesh_poses[0].position.z=0.05;
